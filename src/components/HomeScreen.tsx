          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-2xl bg-emerald-50/30 dark:bg-emerald-950/20 border border-emerald-500/20 space-y-3 flex flex-col justify-between">
              <div>
                ...
                {/* Critical digestive & activity warning for high performance pets */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-[9px] font-extrabold bg-[#D4AF37] text-stone-950 shadow-2xs">
                    AI
                  </span>
                </div>
