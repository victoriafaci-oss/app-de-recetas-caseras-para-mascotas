...
export const ToxicFoodsScreen: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-12 animate-in fade-in duration-300">
      ...
      {/* Header Banner */}
      <div className="rounded-3xl p-6 sm:p-8 bg-gradient-to-br from-rose-950 via-stone-900 to-[#121B15] border border-rose-500/30 text-white shadow-xl">
        <div className="max-w-3xl space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold bg-rose-500/20 text-rose-300 border border-rose-500/40">
            <ShieldAlert className="w-3.5 h-3.5" />
            Directorio Clínico de Seguridad & Toxicología
          </div>
          <h1 className="font-editorial text-3xl sm:text-4xl font-bold text-white">
            Alimentos Prohibidos y Tóxicos para Mascotas
          </h1>
          <p className="text-xs sm:text-sm text-stone-300 leading-relaxed font-light">
            Guía de referencia rápida con compuestos nocivos, sintomatología de intoxicación, protocolos de urgencia veterinaria y sustitutos gastronómicos 100% seguros.
          </p>
        </div>
      </div>
      ...
      <div className="p-4 sm:p-5 rounded-2xl bg-amber-500/10 border border-amber-500/30 dark:bg-amber-950/20 text-xs text-amber-950 dark:text-amber-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xs">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-bold text-sm block">¿Sospecha de ingestión accidental reciente?</span>
            <span>No intente provocar el vómito sin supervisión. Acuda de inmediato a un hospital veterinario 24h con la muestra del producto o envase.</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-center justify-between p-4 rounded-2xl bg-white dark:bg-[#121B15] border border-stone-200 dark:border-[#D4AF37]/20 shadow-xs">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            type="text"
            placeholder="Buscar alimento (chocolate, cebolla, uvas...)"
            value={searchQuery}
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto w-full sm:w-auto">
          ...
          >
            Todos ({TOXIC_FOODS_CATALOG.length})
          </button>
          <button
            ...
            >
              <div>
                ...
                <div className="flex items-start justify-between gap-3 mb-2">
                  <div>
                    <span className="text-[10px] uppercase font-bold tracking-wider text-stone-600 dark:text-stone-400">
                      Afecta a: {food.speciesAffected === 'all' ? '🐕 Perros y 🐈 Gatos' : food.speciesAffected === 'dog' ? '🐕 Perros' : '🐈 Gatos'}
                    </span>
                  ...
                  <span className={`px-2.5 py-1 rounded-full text-xs font-bold shrink-0 border ${
                    ...
                    {isLethal ? '💀 Nivel Letal' : isHigh ? '⚠️ Riesgo Alto' : '⚡ Moderado'}
                  </span>
                </div>
                ...
                <div className="p-2.5 rounded-xl bg-stone-100 dark:bg-black/30 border border-stone-200 dark:border-stone-800/80 text-xs text-stone-800 dark:text-stone-200 font-mono mb-3">
                  <span className="font-bold text-rose-700 dark:text-rose-400">Principio Tóxico:</span> {food.toxicCompound}
                </div>

                {/* Symptoms */}
                <div className="space-y-1 text-xs text-stone-700 dark:text-stone-300 mb-3">
                  <span className="font-bold text-stone-900 dark:text-stone-100 block">Sintomatología Clínica:</span>
                ...
                <div className="p-3 rounded-xl bg-rose-500/10 border border-rose-500/20 text-xs text-rose-950 dark:text-rose-300">
                  <span className="font-bold block mb-0.5">Protocolo de Emergencia:</span>
              ...
              {food.safeAlternatives && (
                <div className="pt-3 border-t border-stone-200 dark:border-stone-800 flex items-start gap-2 text-xs text-emerald-950 dark:text-emerald-300 font-medium">
                  ...
                  <div>
                    <span className="font-bold text-emerald-800 dark:text-emerald-400">Alternativa Gourmet Segura: </span>
